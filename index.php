...
<form action="registration.php" method="POST" onSubmit = "return checkPassword(this)">
                            <div class="sign-up-htm">
                                ...
                                <div class="group">
                                    ...
                                    <input id="pass" type="text" class="input" name="mobile" pattern="[0-9]{10}">
                                </div>
    ...
    <div id="webtitle">
        <div class="card-body">
            <h1 class="card-title text-center">Discussion Forum<br> <span style="Font-size:0.20in;"><small>VVCE,7th SEM CSE B</small></span>  </h1>
        </div>
    </div>
